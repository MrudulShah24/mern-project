...
exports.enrollInCourse = async (req, res) => {
  try {
    ...
    // Check if the user is somehow enrolled via another method (rare edge case now)
    const alreadyEnrolledInCourse = false; // We no longer track this on the Course model
    ...
    // Add to enrolledCount in Course model
...
exports.checkEnrollmentStatus = async (req, res) => {
  try {
    ...
    const enrollmentRecord = await Enrollment.findOne({ user: userId, course: courseId });
