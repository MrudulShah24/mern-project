...
import { Users, Book, BarChart2, Trash2, Search, X, Edit, Shield, CheckCircle, PlusCircle } from "lucide-react";
                ...
                {loading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                            <p className="text-sm text-purple-600 dark:text-purple-400">Total Enrollments</p>
                            <p className="text-3xl font-bold text-purple-700 dark:text-purple-300">{enrollmentStats.total}</p>
                        </div>
                        <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                            <p className="text-sm text-blue-600 dark:text-blue-400">Active Courses</p>
                            <p className="text-3xl font-bold text-blue-700 dark:text-blue-300">{enrollmentStats.active}</p>
                        </div>
                        <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                            <p className="text-sm text-green-600 dark:text-green-400">Completed Courses</p>
                            <p className="text-3xl font-bold text-green-700 dark:text-green-300">{enrollmentStats.completed}</p>
                        </div>
                    </div>
                )}
            </div>
                ...
                {loading ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
                            <p className="text-sm text-yellow-600 dark:text-yellow-400">Total Certificates</p>
                            <p className="text-3xl font-bold text-yellow-700 dark:text-yellow-300">{certificateStats.total}</p>
                        </div>
                        <div className="p-4 bg-teal-50 dark:bg-teal-900/20 rounded-lg">
                            <p className="text-sm text-teal-600 dark:text-teal-400">Verified Certificates</p>
                            <p className="text-3xl font-bold text-teal-700 dark:text-teal-300">{certificateStats.verified}</p>
                        </div>
                    </div>
                )}
            </div>
                        ...
                        users.map((user) => (
                            <tr key={user._id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 border-b dark:border-gray-700">
                                ...
                                <td className="p-4 flex space-x-2">
                                    <button onClick={() => openEditModal('users', user)} className="p-2 text-gray-500 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400"><Edit size={18} /></button>
    ...
    <div>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md">
            <div className="flex justify-between items-center mb-4">
                ...
                <Link to="/create-course" className="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 flex items-center">
                    <PlusCircle className="w-4 h-4 mr-2" /> Add New Course
                </Link>
            </div>
            <div className="overflow-x-auto">
                <table className="w-full text-left">
                    <thead><tr className="bg-gray-50 dark:bg-gray-700/50 border-b dark:border-gray-700"><th className="p-4 font-semibold text-gray-600 dark:text-gray-300">Title</th><th className="p-4 font-semibold text-gray-600 dark:text-gray-300">Category</th><th className="p-4 font-semibold text-gray-600 dark:text-gray-300">Modules</th><th className="p-4 font-semibold text-gray-600 dark:text-gray-300">Actions</th></tr></thead>
                    <tbody>
                        ...
                        courses.map((course) => (
                            <tr key={course._id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 border-b dark:border-gray-700">
                                ...
                                <td className="p-4 text-gray-800 dark:text-gray-300">{course.modules?.length || 0}</td>
                                <td className="p-4 flex space-x-2">
                                    <button onClick={() => openEditModal('courses', course)} className="p-2 text-gray-500 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400"><Edit size={18} /></button>
