  ...
  if (error) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center text-center p-6">
        ...
        <Link to="/dashboard" className="px-6 py-2 bg-gradient-to-r from-amber-400 to-orange-500 text-slate-900 font-semibold rounded-lg hover:brightness-105 transition shadow-md">Back to Dashboard</Link>
      </div>
    );
  }
  if (!data) return null;
