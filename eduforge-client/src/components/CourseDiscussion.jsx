      ...
      <div className="flex border-b border-gray-200 dark:border-gray-700 mb-6">
        <button
          ...
          className={`px-4 py-3 font-medium text-sm transition-colors ${
            activeTab === 'reviews'
              ? 'border-b-2 border-amber-500 text-amber-600 dark:text-amber-400 dark:border-purple-400'
          ...
          <form onSubmit={submitReview} className="mb-8 p-4 bg-gray-50 dark:bg-gray-900/50 rounded-lg">
            ...
            <div className="mb-4">
              <textarea
                ...
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200 focus:ring-2 focus:ring-amber-500 focus:border-transparent"
                rows="3"
            ...
            <button
              type="submit"
              className="px-5 py-2 bg-gradient-to-r from-amber-400 to-orange-500 text-slate-900 font-semibold rounded-lg hover:brightness-105 shadow-md transition-colors"
            >
              Submit Review
            </button>
          </form>
        ...
        <div>
          ...
          <form onSubmit={submitMessage} className="flex space-x-3 items-center sticky bottom-0 bg-white dark:bg-gray-800 py-4">
            ...
            <input
              ...
              className="flex-1 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-full bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-200 focus:ring-2 focus:ring-amber-500 focus:border-transparent"
              required
            />
            <button
              type="submit"
              className="p-2 bg-gradient-to-r from-amber-400 to-orange-500 text-slate-900 rounded-full hover:brightness-105 disabled:opacity-50 transition-colors"
              disabled={!newMessage}
            >
