    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden">
      ...
      <div className="p-6 border-b border-gray-200 dark:border-gray-700">
        ...
        <div className="flex items-center mb-2">
          <Code className="w-4 h-4 mr-2 text-amber-600" />
        ...
        {exerciseData.hint && (
          <div className="mt-4">
            <button
              ...
              className="text-sm text-amber-600 dark:text-amber-400 hover:text-amber-600 dark:hover:text-amber-600"
            >
              {showHint ? 'Hide Hint' : 'Show Hint'}
            </button>
            
            {showHint && (
              <div className="mt-2 p-3 bg-amber-50 dark:bg-amber-500/10 text-amber-700 dark:text-purple-300 rounded-md text-sm">
                {exerciseData.hint}
              </div>
            )}
          </div>
          ...
          <div className="flex items-center justify-between bg-gray-100 dark:bg-gray-700 px-4 py-2">
            ...
            <div className="flex space-x-2">
              <button
                ...
                className="p-1.5 text-gray-500 hover:text-amber-600 dark:text-gray-400 dark:hover:text-amber-400 rounded-full hover:bg-gray-200 dark:hover:bg-gray-600"
                title="Copy code"
              >
      ...
      <div className="p-4 border-t border-gray-200 dark:border-gray-700 flex flex-wrap items-center justify-between gap-3">
        ...
        <button
          ...
          className="px-6 py-2 bg-gradient-to-r from-amber-400 to-orange-500 text-slate-900 font-semibold rounded-lg hover:brightness-105 shadow-md transition-colors flex items-center"
        >
