...
const CourseRating = ({ courseId }) => {
  ...
  const renderRatingStats = () => (
    <div className="glass-panel p-6 mb-8 shadow-sm bg-white/30 dark:bg-slate-950/20">
      ...
      {!userReview && (
        <button
          ...
          className="mt-6 w-full px-4 py-2 bg-amber-500 text-white rounded-lg hover:bg-amber-400 transition"
        >
          Write a Review
        </button>
      )}
  ...
  const renderReviewForm = () => (
    <div className="glass-panel p-6 mb-8 shadow-md bg-white/40 dark:bg-slate-950/30">
      ...
      <form onSubmit={handleSubmitReview}>
        ...
        <div className="flex space-x-3">
          <button
            type="submit"
            disabled={submitting}
            className="px-4 py-2 bg-amber-500 text-white rounded-lg hover:bg-amber-400 transition disabled:opacity-50"
          >
  ...
  const renderUserReview = () => {
    ...
    return (
      <div className="bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/30 rounded-lg p-6 mb-8">
        <div className="flex justify-between items-start">
          <div className="flex items-center space-x-3">
            <div className="bg-amber-100 dark:bg-amber-500/20 rounded-full p-3">
              <UserCircle className="w-6 h-6 text-amber-600 dark:text-amber-300" />
            </div>
            <div>
  ...
  const renderReviewList = () => (
    <div>
      ...
      {reviews.length === 0 ? (
        <div className="glass-panel p-10 text-center shadow-md bg-white/30 dark:bg-slate-950/20">
        ...
        <div className="space-y-6">
          {reviews.map(review => (
            <div
              key={review._id}
              className="glass-panel p-6 shadow-sm bg-white/30 dark:bg-slate-950/20"
            >
              <div className="flex justify-between items-start">
                <div className="flex items-center space-x-3">
  ...
  if (error && reviews.length === 0) {
    return (
      <div className="glass-panel p-6 shadow-md">
        ...
        <div className="glass-panel p-8 text-center shadow-md bg-white/30 dark:bg-slate-950/20">
          ...
          <div className="mt-4">
            <button 
              ...
              className="px-4 py-2 bg-amber-500 hover:bg-amber-400 rounded-lg text-white font-medium transition-colors"
            >
              Try Again
            </button>
          </div>
